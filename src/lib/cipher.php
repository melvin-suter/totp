...
class Cipher
{
    ...
    public function __construct($pass = "asdf")
    {
        $this->cipherKey = getenv('APP_KEY').$pass;

     
    }

    public function check(){
        $encrypted = file_get_contents(__DIR__.'/../data/key.txt');
        return $this->decrypt($encrypted) == getenv('APP_KEY');
    }
